...
description: Audits HTML/CSS files for WCAG 2.2 AA compliance, identifying accessibility issues with specific fixes for color contrast, alt text, heading hierarchy, ARIA labels, and keyboard navigation
